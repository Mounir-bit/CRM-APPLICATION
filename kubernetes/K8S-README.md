...
```
$ docker image tag orderservice repo/orderservice
$ docker push repo/orderservice
$ docker image tag storeservice repo/storeservice
$ docker push repo/storeservice
$ docker image tag webstore repo/webstore
$ docker push repo/webstore
```
...
```
$ kubectl get svc webstore -n jhipster
```
